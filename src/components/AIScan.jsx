...
export default function AIScan() {
  ...
  useEffect(() => {
    aiApi
      ...
      .catch(() => setModelInfo({ service_online: false, model_name: 'unreachable' }))
  }, [])
  ...
  const runScan = async () => {
    ...
    try {
      ...
      setError(err?.response?.data?.message || err.message || 'Scan gagal — cek login + Laravel + AI service')
    } finally {
      setBusy(false)
    }
  }
  ...
  return (
    <div>
      ...
      <div className="page-subtitle">
        Upload foto rak → deteksi objek + mapping ke kategori produk. Pipeline: React → Laravel → Python YOLOv8.
      </div>
        ...
        <div className="panel">
          ...
          <div className="panel-body" style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            >
              ...
              <div style={{ fontWeight: 700 }}>Klik / drop foto rak di sini</div>
