    ...
    const mockProducts = [
      {
        ...
        stock: 45,
        min_stock: 10,
        specifications: { Ampere: "20A", Pole: "1P", Breaking: "6kA" },
      },
      {
        id: 2,
        ...
        stock: 32,
        min_stock: 10,
        specifications: { Ampere: "10A", Pole: "1P", Breaking: "6kA" },
      },
      {
        id: 3,
        ...
        stock: 3,
        min_stock: 15,
        specifications: { Ampere: "20A", Pole: "1P", Breaking: "4.5kA" },
      },
      {
        id: 4,
        ...
        stock: 12,
        min_stock: 5,
        specifications: { Type: "NYM", Core: "2×2.5mm²", Panjang: "50m" },
      },
      {
        id: 5,
        ...
        stock: 8,
        min_stock: 5,
        specifications: { Type: "NYM", Core: "3×2.5mm²", Panjang: "50m" },
      },
      {
        id: 6,
        ...
        stock: 20,
        min_stock: 10,
        specifications: { Type: "NYA", Size: "2.5mm", Panjang: "100m" },
      },
      {
        id: 7,
        ...
        stock: 120,
        min_stock: 25,
        specifications: { Base: "E27", Material: "Porselen", MaxWatt: "60W" },
      },
      {
        id: 8,
        ...
        stock: 65,
        min_stock: 20,
        specifications: { Base: "GU10", Material: "Keramik", MaxWatt: "50W" },
      },
      {
        id: 9,
        ...
        stock: 55,
        min_stock: 20,
        specifications: { Gang: "1", Warna: "Putih", Material: "PVC" },
      },
      {
        id: 10,
        ...
        stock: 42,
        min_stock: 15,
        specifications: { Gang: "2", Warna: "Putih", Material: "PVC" },
      },
    ];
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          <p style={{ fontSize: 13, color: "#475569", marginBottom: 16 }}>
            QR Code ini tidak valid atau produk sudah dihapus
          </p>
          <button
