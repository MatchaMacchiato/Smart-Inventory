...
const TITLES = {
  ...
  eoq: "Optimasi EOQ",
  rekomendasi: "Rekomendasi Pengadaan",
  ar: "AR 3D Viewer",
...
const ALL_MENUS = [
  {
    key: "dashboard",
    name: "Dashboard",
    desc: "Ringkasan performa & visualisasi stok",
    icon: "fa-th-large",
    cat: "Menu Utama",
  },
  {
  ...
  },
  {
    key: "barang-masuk",
    name: "Barang Masuk",
    desc: "Input penerimaan & scan barcode masuk",
    icon: "fa-arrow-down",
    cat: "Operasional",
  },
  {
    key: "barang-keluar",
    name: "Barang Keluar",
    desc: "Input pengeluaran & scan barcode keluar",
    icon: "fa-arrow-up",
    cat: "Operasional",
  },
  {
    key: "laporan",
    name: "Laporan Stok",
    desc: "Riwayat mutasi, kartu stok & export data",
    icon: "fa-chart-bar",
    cat: "Operasional",
  },
  {
    key: "ai-asisten",
    name: "Asisten AI",
    desc: "Konsultasi stok & rekomendasi cerdas",
    icon: "fa-robot",
    cat: "Tools AI",
  },
  {
    ...
    desc: "Analitik tingkat lanjut & prediksi stok",
    icon: "fa-brain",
    cat: "Tools AI",
  },
  {
    key: "bom-ai",
    name: "BOM AI Material",
    desc: "Bill of Materials & estimasi RAB proyek",
    icon: "fa-magic",
    cat: "Tools AI",
  },
  {
    key: "ai-scan",
    name: "AI Scan Rak",
    desc: "Deteksi visual rak berbasis YOLOv8",
    icon: "fa-camera",
    cat: "Tools AI",
  },
  {
    key: "ar",
    name: "AR 3D Viewer",
    desc: "Visualisasi 3D interaktif produk",
    icon: "fa-cube",
    cat: "Tools",
  },
];
