      ...
      <div style={{ marginBottom: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
        <div>
          <h1 style={{ fontSize: 24, fontWeight: 800, letterSpacing: '-0.03em', fontFamily: "'Plus Jakarta Sans','Inter',sans-serif" }}>
            <i className="fas fa-cube" style={{ color: '#334155', marginRight: 8 }}></i>{product.name}
          </h1>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 13, color: '#64748B', marginTop: 4 }}>
            <span>{product.category}</span>
            <span>·</span>
            <span style={{ color: '#334155', fontWeight: 600 }}>3D: {fileName}</span>
          </div>
        </div>
        <button onClick={onBack}
          style={{ padding: '9px 20px', border: '1px solid #E6E8EA', borderRadius: 10, background: '#fff', color: '#475569', fontSize: 13, fontWeight: 500, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8 }}>
          <i className="fas fa-arrow-left"></i> Kembali
        </button>
      </div>

      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
        <div style={{ background: '#fff', border: '1px solid #E6E8EA', borderRadius: 16, padding: 20, minHeight: 400 }}>
          {modelError ? (
            <div style={{ height: 400, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#F1F5F9', borderRadius: 12, color: '#64748B' }}>
            ...
            <model-viewer
              ...
              style={{ width: '100%', height: '400px', background: '#F8FAFC', borderRadius: 12 }}
          ...
          {!isMobile && (
            <div style={{ marginTop: 16, padding: '12px 20px', borderRadius: 10, background: 'rgba(6,182,212,0.1)', color: '#0EA5E9', fontSize: 13, fontWeight: 500, textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div style={{ background: '#fff', border: '1px solid #E6E8EA', borderRadius: 12, padding: 20 }}>
            <h3 style={{ fontSize: 14, fontWeight: 700, marginBottom: 16, fontFamily: "'Plus Jakarta Sans','Inter',sans-serif" }}>
              <i className="fas fa-info-circle" style={{ color: '#334155', marginRight: 8 }}></i>Informasi Produk
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                ...
                { label: 'Stok', value: `${product.stock} unit`, color: product.stock <= product.min_stock ? '#DC2626' : '#059669' },
                { label: 'Min. Stok', value: product.min_stock },
                { label: 'Model 3D', value: fileName },
              ].map((item, i) => (
                <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '6px 0', borderBottom: '1px solid #E6E8EA' }}>
