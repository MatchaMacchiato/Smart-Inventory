  ...
  const detectReal = async () => {
    ...
    try {
      ...
      const detected = Object.values(grouped).map((g) => {
        const product = COCO_TO_PRODUCT[g.class] || {
          name: g.class,
          category: "Unknown",
          price: 0,
        };
      ...
      if (canvas && imgRef.current) {
        ...
        predictions.forEach((p) => {
          ...
          ctx.fillStyle = "rgba(0,86,179,0.8)";
      ...
      setResult({
        products: detected,
        total: detected.reduce((a, b) => a + b.quantity, 0),
        real: true,
      });
    } catch (err) {
      console.error("Detection error:", err);
      setResult({
        products: generateMockResult().products,
        total: 0,
        real: false,
      });
    }
    ...
    <div>
      <div style={{ marginBottom: 24 }}>
        ...
        >
          ...
          {modelLoading && (
            <span style={{ color: "#FF7300" }}>· Loading AI model...</span>
          )}
          {model && <span style={{ color: "#059669" }}>· AI Active ✓</span>}
          {!useRealAI && (
            <span style={{ color: "#DC2626" }}>· Mode: Simulasi</span>
          )}
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
        ...
        <div>
          <div
            ...
            style={{
              border: `2px dashed ${preview ? "#0056b3" : "#E6E8EA"}`,
              borderRadius: 16,
              padding: 40,
              textAlign: "center",
              cursor: "pointer",
              background: preview ? "rgba(0,86,179,0.03)" : "#fff",
              transition: "all 0.3s",
              minHeight: 300,
              position: "relative",
              display: "flex",
            ...
            {preview ? (
              ...
              <>
                ...
                <p style={{ fontSize: 13, color: "#475569", marginBottom: 4 }}>
                  Klik untuk upload gambar rak toko listrik
                </p>
          ...
          >
            ...
            <button
              ...
              style={{
                padding: "6px 14px",
                borderRadius: 8,
                border: useRealAI ? "1px solid #0056b3" : "1px solid #E6E8EA",
                background: useRealAI ? "rgba(0,86,179,0.09)" : "#fff",
                color: useRealAI ? "#0056b3" : "#475569",
                fontSize: 12,
                fontWeight: 600,
                cursor: "pointer",
                transition: "all 0.2s",
            ...
            <button
              ...
              style={{
                padding: "6px 14px",
                borderRadius: 8,
                border: !useRealAI ? "1px solid #FF7300" : "1px solid #E6E8EA",
                background: !useRealAI ? "rgba(255,115,0,0.12)" : "#fff",
                color: !useRealAI ? "#FF7300" : "#475569",
                fontSize: 12,
                fontWeight: 600,
                cursor: "pointer",
              }}
          ...
          {scanning && (
            ...
            >
              ...
              ></div>
              <p style={{ fontSize: 14, fontWeight: 600, color: "#0056b3" }}>
                {useRealAI
          ...
          >
              ...
              {result && (
                <span
                  style={{
                    ...
                    padding: "4px 10px",
                    borderRadius: 8,
                    background: result.real
                      ? "rgba(5,150,105,0.1)"
                      : "rgba(255,115,0,0.12)",
                    color: result.real ? "#059669" : "#FF7300",
                    fontWeight: 600,
                  }}
                >
            ...
            {!result && !scanning && (
              ...
              >
                ...
                <p style={{ fontSize: 14 }}>
                  Upload foto rak untuk memulai deteksi
                </p>
                <p style={{ fontSize: 12 }}>
                  AI akan mendeteksi & menghitung produk otomatis
                </p>
              </div>
            )}
            ...
            {result && (
              <div>
                ...
                >
                  <i className="fas fa-check-circle"></i> {result.total} unit
                  terdeteksi
                </div>
                            ...
                            style={{
                              ...
                              background:
                                item.confidence > 90
                                  ...
                                  : "rgba(255,115,0,0.12)",
                              color:
                                item.confidence > 90 ? "#059669" : "#FF7300",
                            }}
                          >
                            {item.confidence}%
                          </span>
